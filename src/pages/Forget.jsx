...
export default function Forget() {
    ...
    const handleSubmit = async (e) => {
        ...
        const result = await confirmButton("Check Your Email", "Please verify your account to change a password", "success")
            ...
            <div className="bg-white p-8 shadow-2xl rounded-lg max-w-md w-full">
                ...
                <form onSubmit={handleSubmit}>
                    <div className="mb-4">
                        ...
                        <InputText type={"email"} placeholder={"Enter your email"} value={data?.email === "" ? "" : data?.email} onchange={handleInput}
                                   id={"email"}/>
                    </div>
                    <button
                        type="submit"
